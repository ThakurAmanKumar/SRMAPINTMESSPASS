...
export async function GET(
  ...
  try {
    ...
    // Return HTML file that users can print to PDF
...
<head>
    ...
    <meta http-equiv="Content-Security-Policy" content="default-src 'self' 'unsafe-inline' data:; img-src 'self' https: data:; script-src 'none'; object-src 'none';">
...
<body>
    ...
    <script>
        // Auto-print when page loads (optional - user can also use Ctrl+P)
        // window.print();
    </script>
</body>
</html>
