...
export interface NewSuperAdminEmailParams {
  email: string;
  createdByEmail: string;
}
...
/**
 * Generate HTML email for new super admin
 */
export function getNewSuperAdminEmailHTML(params: NewSuperAdminEmailParams): string {
  const loginURL = 'https://srmapimpass.indevs.in/SupAdm/login';
  const forgotPasswordURL = 'https://srmapimpass.indevs.in/SupAdm/forgot-password';
    ...
    <html>
      ...
      <body>
        <div class="container">
          <!-- Header -->
          <div class="header">
            <h1>Welcome to Super Admin Panel!</h1>
            <p>You've been added as a Super Admin</p>
          </div>
          ...
          <div class="content">
            ...
            <p>Congratulations! You have been successfully added as a <strong style="color: #484622;">Super Admin</strong> to the SRMAP International Mess Pass Portal.</p>

            <div class="badge">🎉 SUPER ADMIN ACCESS GRANTED</div>
            ...
            <div class="steps-section">
              ...
              <div class="step">
                <span class="step-number">1</span>
                <span class="step-content">
                  <strong>Visit the Super Admin Login Portal</strong><br>
                  <a href="${loginURL}" style="color: #0284c7; text-decoration: none;">${loginURL}</a>
                </span>
              </div>
              ...
              <div class="step">
                <span class="step-number">8</span>
                <span class="step-content">
                  <strong>Access Super Admin Dashboard</strong><br>
                  You're ready to manage the entire system!
                </span>
              </div>
            </div>
            ...
            <div style="text-align: center; margin: 30px 0;">
              <p style="margin: 0 0 15px 0; font-weight: bold;">Ready to get started?</p>
              <a href="${loginURL}" class="action-button" style="color: white !important;">Go to Super Admin Login</a>
            </div>
            ...
            <p style="margin-top: 30px; color: #666;">If you have any questions or need assistance, please contact the system administrator.</p>
...
/**
 * Generate text email for new super admin
 */
export function getNewSuperAdminEmailText(params: NewSuperAdminEmailParams): string {
  const loginURL = 'https://srmapimpass.indevs.in/SupAdm/login';
  
  return `
WELCOME TO SUPER ADMIN PANEL
You've Been Added as a Super Admin

Dear ${params.email},

Congratulations! You have been successfully added as a Super Admin to the SRMAP International Mess Pass Portal.

STEPS TO SETUP YOUR CREDENTIALS:

1. Visit the Super Admin Login Portal
   ${loginURL}
...
8. Access Super Admin Dashboard
   You're ready to manage the entire system!
